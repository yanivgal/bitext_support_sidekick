...
_system_prompt = (
    ...
    "- User memory and profile queries (e.g., what do you remember about me, what are my preferences, etc.)"
    "- Next query recommendations (e.g., advise me what to query next, suggest questions, etc.)"
    ...
    "- If the query is about user memory, preferences, or asking for recommendations, classify it as 'in_scope'.\n"
    ...
    "- 'What do you remember about me?' → in_scope\n"
    "- 'Advise me what to query next' → in_scope\n"
